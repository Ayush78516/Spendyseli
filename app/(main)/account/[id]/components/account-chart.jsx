...
const AccountChart = ({transactions}) => {
  ...
  const filteredData=useMemo(()=>{
    ...
    const startDate=range.days ? 
      ...
      //Keeps only those transactions that happened between startDate and today
      ...
      //Create a new object for that day if it doesn't exist
        if(!acc[date]){
      ...
      //Object.values() turns grouped object into an array
    ...
    <Card>
      ...
      <div className="h-[320px]">
        ...
        >
          ...
          <Legend />
          <Bar dataKey="income" name="Income" fill="#5deca9ff" radius={[4,4,0,0]}/>
          <Bar dataKey="expense" name="Expense" fill="#e68d6dff" radius={[4,4,0,0]}/>
        </BarChart>
        </ResponsiveContainer>
      </div>
      </CardContent>
